...
const Quiz = () => {
    ...
    return (
        <Card className='mx-2'>
            ...
            <CardFooter>
                {!showExplanation && (
                    <Button onClick={() => setShowExplanation(true)} variant={'outline'} disabled={!answers[currentQuestion] || savingResult}>
                        {savingResult && (
                ...
                <Button onClick={handleNext} variant={'outline'} disabled={!answers[currentQuestion]} className='ml-auto'>
