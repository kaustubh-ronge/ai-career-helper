...
//                     <form className='space-y-8 pt-2' onSubmit={handleSubmit(onSubmit)}>

//                         {/* Contact Information */}
//                         <div className='space-y-4'>
//                             <h3 className='text-lg font-medium'>Contact Information</h3>
//                             <div className='grid grid-cols-1 md:grid-cols-2 gap-4 border rounded-lg bg-muted/32 p-4'>
